        ...
        <div className="container">
          <div className="flex flex-wrap justify-between pt-10">
            <div className='text-white font-bold'>
              <h1 className='text-5xl leading-tight'>Start Your Day with <br /> Coffee and Good Meals</h1>
              <h2 className='text-xl my-10'>We provide high quality beans, good taste, and healthy <br /> meals made by love just for you. Start your day with us <br /> for a bigger smile!</h2>
